...
So, I had everything inside the website. Which includes: Input & forms, feedback & status, layout & structure, data presentation. The one I dont' have is navigation. So I made navigation using breadcrumbs. 
...
Phone: 
<img width="428" height="317" alt="Screenshot 2025-12-09 at 09 38 23" src="https://github.com/user-attachments/assets/d0abbb30-b9b0-47d0-b108-f173d5082035" />


# PART C


| No | Summary Test Scenario | Pre-requisite | Test Case | Expected Result |
| --- | --- | --- | --- | --- |
| 1  | User must be able to see and go back to the previous page using breadcrumbs  | Click checkout  | User clicks breadcrumb (Back to products)  | User goes back to products (PASSED) |
| 2  | User is able to use the form  | Click checkout  | Fill in form  | Placeholders change to input  |
| 3  | User is able to know when the form is sent  | Submit form  | Fill in form & submit form  | Shows text that says the form is submitted  |
| 4  | User is able to see the website in card view  | Click checkout  | Access payment.html part of the web page  | Shows in card view  |
| 5  | User is able to use the website in phone  | Click checkout  | Access web page with mobile devices | Interactive  |
